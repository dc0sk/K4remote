...
use k4_protocol::cat::{
    ...
    menu_query_def, menu_set, rx_eq_flat, send_text, set_af_gain, set_agc, set_apf, set_attenuator,
    set_auto_notch, set_band, set_band_sub, set_bandwidth_hz, set_compression, set_cw_pitch,
    set_diversity, set_filter_preset, set_keyer, set_keyer_speed, set_line_in, set_line_out,
    set_manual_notch, set_mic_gain, set_mic_input, set_mic_setup, set_mode, set_mode_sub, set_nb,
