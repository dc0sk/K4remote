...
pub const TIPS: &[(&str, &str)] = &[
    ...
    ("rx.nb", "Noise blanker (NB): tap for on/off, hold to cycle the filter mode NONE/NARROW/WIDE. Narrow or wide removes QRM ahead of the blanker if you hear pumping."),
    ...
    ("rx.afgain", "AF gain of the active receiver (AG). Sets the RADIO's volume — the shack speaker follows it."),
    ...
    // --- Antenna ---------------------------------------------------------
    ("pan.target", "Which pan SPAN applies to — the two pans hold independent spans. Reference and scale are global on this radio and apply to both regardless."),
